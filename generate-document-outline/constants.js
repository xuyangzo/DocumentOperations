...
const outputDescription = "The output is a JSON array. The objects in the JSON array has the key property to be the abstract, and the value to be the page index. The key property should be less than 4 words if possible. The start index is 1.\n\n";
